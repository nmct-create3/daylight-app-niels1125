...
let showResult = queryResponse => {
  ...
  document.querySelector(
    '.js-sunrise'
  ).innerHTML = _parseMillisecondsIntoReadableTime(queryResponse.city.sunrise);
  document.querySelector(
    '.js-sunset'
  ).innerHTML = _parseMillisecondsIntoReadableTime(queryResponse.city.sunset);
...
let getAPI = (lat, lon) => {
  const appid = '0a9ed747f9b249b125b1eceaae2dd3e4';
